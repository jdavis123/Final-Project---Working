...
ncaa2013<-read.table("/Users/joshdavis1001/Documents/Final-Project---Working/2013.stats.csv",
           sep=",",
           header=TRUE,
           as.is=TRUE)
...
ncaa2012<-read.table("/Users/joshdavis1001/Documents/Final-Project---Working/2012.stats.csv",
                     sep=",",
                     header=TRUE,
                     as.is=TRUE)
...
ncaa2011<-read.table("/Users/joshdavis1001/Documents/Final-Project---Working/2011.stats.csv",
                     sep=",",
                     header=TRUE,
                     as.is=TRUE)
...
ncaa2010<-read.table("/Users/joshdavis1001/Documents/Final-Project---Working/2010.stats.csv",
                     sep=",",
                     header=TRUE,
                     as.is=TRUE)
